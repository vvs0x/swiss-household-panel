...
\thesistitle{The Giving Block}             % Thesis title,              command: \ttitle
\newcommand{\tsubtitle}{Blockchain-Technologie für transparente Spenden}  % Subtitle,                   command: \tsubtitle
\thesistype{Technischer Kurzbericht (LNW3)} % Type of thesis              \ttype
\thesisdate{Winterthur, \today}                     % Date of submission                  \tdate
\newcommand{\charcount}{\livecharcount\,Zeichen ohne Leerzeichen (Kap.~1--4)}  % Live char count via \directlua, see preamble.tex
\keywords{}
                                        % Keywords for the thesis,            \keywordnames
\author{Berdelis, Phineas (berdephi) \\Schwarz, Valentín (schwava1)}                  % Your name,                          \authorname
\degree{}          % Degree name,                        \degreename
\studyprogram{DS25a / T13} 
                                        % Study program                       \studyprog
\studyprogramlink{}
                                        % Link to study program               \studyproglink

\supervisorA{Aline Bieri}       % Name of supervisor 1,               \supnameA
\supervisorAmail{}         % Email address of supervisor 1,      \supmailA
...
\pagestyle{centerfoot}        % Page number bottom centered (also for frontmatter)
...
\pagestyle{centerfoot} % Page number bottom centered, no header
