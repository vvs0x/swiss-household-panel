...
Auswahl der zusätzlichen Einflussvariable \emph{CIVSTA}.
...
Verzeichnis & Inhalt \\
\midrule
\texttt{data/raw/}           & Unveränderte SHP-Rohdaten im SPSS-Format. \\
...
\texttt{docs/bericht/}       & Dokumentation: Aufgabenstellung, SHP User Guide sowie das \LaTeX-Projekt für den vorliegenden technischen Bericht. \\
...
\texttt{.gitignore}          & Alle Rohdaten sind im .gitignore aufgrund der Forderungen von FORS. \\
\bottomrule
\end{tabularx}
\end{table}
