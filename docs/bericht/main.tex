...
\thesistitle{Swiss Household Data}             % Thesis title,              command: \ttitle
\thesistype{Technischer Bericht}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{\today}                     % Date of submission                  \tdate
\keywords{}
                                        % Keywords for the thesis,            \keywordnames
\author{Phineas Berdelis \& \\Valentín Schwarz}                  % Your name,                          \authorname
\degree{}          % Degree name,                        \degreename
\studyprogram{Data Processing with R} 
                                        % Study program                       \studyprog
\studyprogramlink{}
                                        % Link to study program               \studyproglink

\supervisorA{Dr. Christoph Hofer \&}       % Name of supervisor 1,               \supnameA
...
\supervisorB{Martina Schwegler}              % Name of supervisor 2,               \supnameB
